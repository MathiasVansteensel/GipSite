        ...
        if (a && "string" == typeof a) {
            if (/^\d+$/.test(a)) g = new Date(a);
                ...
                for (
                    ...
                    ["d", "dd"].indexOf(f[d]) > -1 ?
                    (j = parseInt(e[d], 10)) : ["m", "mm"].indexOf(f[d]) > -1 ?
                    (i = parseInt(e[d], 10) - 1) :
                    "mmm" === f[d] ?
                    ...
                    "mmmm" === f[d] ?
                    (i = gj.core.messages[c || "en-us"].monthNames.indexOf(e[d])) : ["yy", "yyyy"].indexOf(f[d]) > -1 ?
                    ((h = parseInt(e[d], 10)), "yy" === f[d] && (h += 2e3)) : ["h", "hh", "H", "HH"].indexOf(f[d]) > -1 ?
                    (k = parseInt(e[d], 10)) : ["M", "MM"].indexOf(f[d]) > -1 && (l = parseInt(e[d], 10));
